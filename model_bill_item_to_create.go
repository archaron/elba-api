...
// checks if the BillItemToCreate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillItemToCreate{}

// BillItemToCreate struct for BillItemToCreate
type BillItemToCreate struct {
...
type _BillItemToCreate BillItemToCreate
...
func (o *BillItemToCreate) SetPriceNil() {
	o.Price.Set(nil)
}
...
func (o *BillItemToCreate) SetNdsRateNil() {
	o.NdsRate.Set(nil)
}
...
func (o *BillItemToCreate) SetDiscountNil() {
	o.Discount.Set(nil)
}
...
func (o BillItemToCreate) MarshalJSON() ([]byte, error) {
...
func (o BillItemToCreate) ToMap() (map[string]interface{}, error) {
...
func (o *BillItemToCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varBillItemToCreate := _BillItemToCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBillItemToCreate)

	if err != nil {
		return err
	}

	*o = BillItemToCreate(varBillItemToCreate)

	return err
}

type NullableBillItemToCreate struct {
	value *BillItemToCreate
	isSet bool
}

func (v NullableBillItemToCreate) Get() *BillItemToCreate {
	return v.value
}

func (v *NullableBillItemToCreate) Set(val *BillItemToCreate) {
	v.value = val
	v.isSet = true
}

func (v NullableBillItemToCreate) IsSet() bool {
	return v.isSet
}

func (v *NullableBillItemToCreate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillItemToCreate(val *BillItemToCreate) *NullableBillItemToCreate {
	return &NullableBillItemToCreate{value: val, isSet: true}
}

func (v NullableBillItemToCreate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillItemToCreate) UnmarshalJSON(src []byte) error {
	v.isSet = true
